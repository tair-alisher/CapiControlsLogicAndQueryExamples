...
{
    internal class FormSixSectionFiveEducation : BaseControl<AnswerDataWithValidRow>, IControl
    {
        public FormSixSectionFiveEducation(string connection) : base(connection) { }
