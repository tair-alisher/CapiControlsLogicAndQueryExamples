...
{
    internal class FormSixSectionSixAlimonyPayment : BaseControl<AnswerDataWithValidRow>, IControl
    {
        public FormSixSectionSixAlimonyPayment(string connection) : base(connection) { }
