...
{
    internal class OtherTaxes : BaseControl<AnswerData>, IControl
    {
        ...
        public void Execute()
        {
            ...
            Console.WriteLine("Раздел 6. Вопрос 35. Какова была сумма расходов на уплату других налогов. Проверено.");
        }
    ...
    ,'Форма 6' as Form
    ,'Раздел 6' as Section
    ,'Вопрос 35' as QuestionNumber
    ,'Какова была сумма расходов на уплату других налогов?' as QuestionText
...
where (
        ...
        where _qe.stata_export_caption = 'f6r6q34'
            and _id.interviewid = i_id.interviewid
        limit 1
    ) = 1
    and qe.stata_export_caption = 'f6r6q35A1'
    and ((
