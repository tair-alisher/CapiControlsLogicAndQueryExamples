...
{
    internal class IncomeTax : BaseControl<AnswerData>, IControl
    {
        public IncomeTax(string connection) : base(connection) { }

        public void Execute()
        {
            CheckAnswers(base.CreateFile());
            Console.WriteLine("Раздел 6. Вопрос 17. Какую сумму Вы израсходовали на уплату подоходного налога. Проверено.");
        }
    ...
    ,'Форма 6' as Form
    ,'Раздел 6' as Section
    ,'Вопрос 17' as QuestionNumber
    ,'Какую сумму Вы израсходовали на уплату подоходного налога?' as QuestionText
...
where qe.stata_export_caption = 'f6r6q17A1'
    and (
        select _i.asint
        ...
        where _qe.stata_export_caption = 'f6r6q16'
