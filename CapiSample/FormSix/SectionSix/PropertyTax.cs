...
{
    internal class PropertyTax : BaseControl<AnswerData>, IControl
    {
        public PropertyTax(string connection) : base(connection) { }

        public void Execute()
        {
            CheckAnswers(base.CreateFile());
            Console.WriteLine("Раздел 6. Вопрос 15. Какую сумму Вы израсходовали на уплату налога на недвижимость. Проверено.");
        }
    ...
    ,'Форма 6' as Form
    ,'Раздел 6' as Section
    ,'Вопрос 15' as QuestionNumber
    ,'Какую сумму Вы израсходовали на уплату налога на недвижимость?' as QuestionText
    ,'Указать сумму налога' as InfoMessage
...
where (
        ...
        where _qe.stata_export_caption = 'f6r6q14'
            and _id.interviewid = i_id.interviewid
        limit 1
    ) = 1
    and qe.stata_export_caption = 'f6r6q15A1'
    and ((
