...
{
    internal class Insurance : BaseControl<AnswerData>, IControl
    {
        public Insurance(string connection) : base(connection) { }

        public void Execute()
        {
            CheckAnswers(base.CreateFile());
            Console.WriteLine("Раздел 6. Вопрос 21. Какова сумма взносов по всем видам страхования. Проверено.");
        }
    ...
    ,'Форма 6' as Form
    ,'Раздел 6' as Section
    ,'Вопрос 21' as QuestionNumber
    ,'Какова сумма взносов по всем видам страхования?' as QuestionText
...
where qe.stata_export_caption = 'f6r6q21A1'
    and (
        select _i.asint
        ...
        where _qe.stata_export_caption = 'f6r6q20'
