...
{
    internal class FinancialSupport : BaseControl<AnswerData>, IControl
    {
        ...
        public void Execute()
        {
            ...
            Console.WriteLine("Раздел 6. Вопрос 29. Какую сумму составила помощь. Проверено.");
        }
    ...
    ,'Форма 6' as Form
    ,'Раздел 6' as Section
    ,'Вопрос 29' as QuestionNumber
    ,'Какую сумму составила помощь?' as QuestionText
...
where qe.stata_export_caption = 'f6r6q29A1'
    and (
        select _i.asint
        ...
        where _qe.stata_export_caption = 'f6r6q28'
